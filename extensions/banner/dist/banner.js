...
${errorInfo.componentStack}`);
  ...
  // extensions/banner/src/Checkout.jsx
  ...
  function Extension() {
    const [appsubscription, setAppsubscription] = (0, import_react15.useState)(false);
    const translate = useTranslate();
    const { sessionToken, extension: extension2 } = useApi();
    ...
    function getSubscriptionDetail(url) {
      return __async(this, null, function* () {
        console.log("url");
        console.log(url);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: "banner", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Hi There" }) });
  }
})();
